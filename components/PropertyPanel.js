            ...
            <div className="property-section">
              ...
              {currentSlide ? (
                <>
                  <label>タイトル</label>
                  <textarea
                    value={currentSlide.overlay?.title || ''}
                    onChange={e => updateSlide('overlay.title', e.target.value)}
                  />
                  <label>サブタイトル</label>
                  <textarea
                    value={currentSlide.overlay?.subtitle || ''}
                    onChange={e => updateSlide('overlay.subtitle', e.target.value)}
                  />
                  <label>ボタンテキスト</label>
                  <input
                    type="text"
                    value={currentSlide.overlay?.buttonText || ''}
                    onChange={e => updateSlide('overlay.buttonText', e.target.value)}
                  />
                  <label>テキスト色</label>
                  <input
                    type="color"
                    value={currentSlide.overlay?.color || '#ffffff'}
                    onChange={e => updateSlide('overlay.color', e.target.value)}
                  />
                  <label>配置</label>
                  <select
        ...
        return (
          <div className="property-content">
            ...
            <div className="property-section">
              ...
              <label style={{ marginTop: '16px' }}>Google Tag Manager ID（オプション）</label>
              <input
                type="text"
                value={gtmId || ''}
